...
void main() async{
  ...
  //print(await startRealAsyncTask());
  //print(await startWorkManger());

}


Future<dynamic> startRealAsyncTask() async{
  Isolate isolate;
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
   ...
   // runforever();
   // startRealAsyncTask();
    print ('left _incrementCounter function');
  }
